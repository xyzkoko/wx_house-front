...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    ...
    <link rel="stylesheet" href="css/boostramp.min.css">
	 <script type="text/javascript" src="js/common.js?v=1.0227"></script>
	  <script type="text/javascript" src="js/myYeWu.js?v=1.138"></script>
...
<div style = "background-color:#258ee7;margin-bottom:10px" class = "col-sm-12 col-xs-12" >
  ...
  <div class="col-sm-12 col-xs-12 " style="margin-bottom:2px">
	  ...
	  <p  style = "text-align:center;margin-left:4px;margin-top:10px;margin-right:10px;color:blue ;font-size:20px">最 近 交 易</p>
	  </div>
	  <div style="font-size:22px" class="btn-group  col-sm-8 col-xs-8 col-sm-offset-2 col-xs-offset-2">    
