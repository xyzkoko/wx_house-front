...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    ...
    <link rel="stylesheet" href="css/boostramp.min.css">
	 <script type="text/javascript" src="js/common.js?v=1.0225"></script>
	  <script type="text/javascript" src="js/bussiness.js?v=1.11"></script>
...
<span style = "background-color: #948F8F;color: white;">原</span><span id = "yPrice" style="text-decoration:line-through;padding-left: 4px;padding-right:12px;color: #948F8F;">￥~~</span>
<span style = "background-color: red;color: white;">会</span><span id = "hPrice" style="padding-left: 4px;color: red;">￥~~</span>
</div>
</div>
...
<div class="row" style = "background-color:#258ee7;padding-bottom:10px;padding-top:10px">
 <p style = "text-align:center;color:white;margin-bottom:0px;font-size:30px" class  = "col-xs-12 col-sm-12">网签办理</p>
  ...
  <p style = "margin-left:14px;color:blue ;font-size:20px;margin-top:15px">卖方信息：</p>
...
<div style = "margin-top:50px">
  <p style = "margin-left:14px;color:blue ;font-size:20px">买方信息：</p>
  <div class="col-sm-12 col-xs-12 " style="padding:0px;margin-bottom:20px">
...
<div style = "margin-top:50px">
 <p style = "margin-left:14px;color:blue ;font-size:20px">交易信息：</p>
...
<div style = "margin-top:50px">
 <p style = "margin-left:14px;color:blue ;font-size:20px">其他信息：</p>
...
<div style = "margin-top:50px">
  <p style = "margin-left:14px;color:blue ;font-size:20px">报告使用银行：</p>
 ...
 <div class = "col-sm-12 col-xs-12">
  ...
  <div class = "col-sm-12 col-xs-12">
   <p style = "margin-left:14px;color:blue ;font-size:20px">房屋外部照片：</p>
   </div>
   <div class="col-sm-12 col-xs-12">
...
<div style = "margin-top:50px">
  <p style = "margin-left:14px;color:blue ;font-size:20px">房屋内部照片：</p>
     <div class="col-sm-12 col-xs-12">
